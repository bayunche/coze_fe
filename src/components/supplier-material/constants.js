...
export const REASON_EXPLANATIONS = {
  SIMILAR_MATCH: '您解析的数据在数据库中未找到，使用AI智能识别推荐使用该物资数据。如果该物资数据是正确的，请您检查价格是否正确。如果物资有误请您点击按钮重选正确的物资与价格数据。',
  NO_MATCH: '您解析的数据在数据库中未找到，使用AI智能识别暂无对应物资价格数据推荐，请点击右边的按钮在数据库中选择或新增物资价格数据。'
}
