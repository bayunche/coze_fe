...
export const handleViewDetail = (row, taskId, router) => {
  ...
  try {
    ...
    console.log('跳转到甲供物资解析详情:', { taskId })
    ...
    console.error('跳转甲供物资解析详情失败:', error)
...
export const goBackToTaskList = (router) => {
  router.push('/smart-brain/owner-material-tasks')
}
...
export const createBreadcrumbItems = (taskId) => {
  return [
    ...
    { text: '甲供物资解析任务', to: '/smart-brain/owner-material-tasks' },
