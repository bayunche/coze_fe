<template>
  <div class="page-container">
    <div class="supplier-material-tasks-page">
      <!-- 页面头部 -->
      ...
      <div class="cards-section" v-loading="loading">
        <div v-if="taskData.length === 0 && !loading" class="empty-state">
          ...
          <div class="empty-text">暂无乙供物资解析任务数据</div>
        </div>
          ...
          >
            ...
            <template #header>
              <div class="card-header">
                <div class="task-info">
                  <h3 class="task-title">{{ item.taskName || '乙供物资解析任务' }}</h3>
                  <div class="task-meta">
...
const fetchTasks = async () => {
  ...
  try {
    ...
    console.error('获取乙供物资解析任务列表失败:', error)
